(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),exports, require('sax'), require('url'), require('buffer'), require('crypto-js/sha1'), require('crypto-js/enc-base64'), require('assert'), require('lodash'), require('uuid/v4'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ngx-soap', ['@angular/core','@angular/common/http','exports', 'sax', 'url', 'buffer', 'crypto-js/sha1', 'crypto-js/enc-base64', 'assert', 'lodash', 'uuid/v4', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/common/http'], factory) :
    (factory(global.ng.core,global.ng.common.http,(global['ngx-soap'] = {}),global.sax,global.url,global.buffer,global.sha1,global.Base64,global.assert,global._,global.uuid4,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.common.http));
}(this, (function (ɵngcc0,ɵngcc1,exports,sax,url,buffer,sha1,Base64,assert,_,uuid4,rxjs,operators,i0,i1) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */function (method, args, location, options, extraHeaders) {
        ...
        return rxjs.from(SoapAttachment.fromFormFiles(options.attachments)).pipe(operators.map(( /**
        ...
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (cache[url$$1]) {
                    ...
                    return [2 /*return*/, open_wsdl(url$$1, options).then(( /**
                             * @param {?} wsdl
                             * @return {?}
                             */function (wsdl) {
                            cache[url$$1] = wsdl;
...
NgxSoapModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgxSoapModule });
NgxSoapModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxSoapModule_Factory(t) { return new (t || NgxSoapModule)(); }, imports: [[
            i1.HttpClientModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxSoapModule, { imports: [ɵngcc1.HttpClientModule] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxSoapModule, [{
        type: i0.NgModule,
        args: [{
                imports: [
                    i1.HttpClientModule
