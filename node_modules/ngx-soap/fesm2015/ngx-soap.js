...
function (obj, name, nsPrefix, nsURI, isFirst, xmlnsAttr, schemaObject, nsContext) {
    ...
    const parts = [];
    /** @type {?} */
    const prefixNamespace = (nsPrefix || qualified) && nsPrefix !== TNS_PREFIX$1;
    /** @type {?} */
    let xmlnsAttrib = '';
    if (nsURI && isFirst) {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxSoapModule, { imports: function () { return [HttpClientModule]; } }); })();
