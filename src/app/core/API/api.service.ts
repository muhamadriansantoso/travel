...
const APIDEV = 'https://www.fixtrips.com/dev/';
const APIPROD = 'https://www.fixtrips.com/prod/';
...
export class APIService {
  ...
  airportList() {
    ...
    return this.http.get(APIDEV + 'api/v1/airportlist', httpOptions);
  }
  ...
  hotelGeolocation() {
    ...
    return this.http.get(APIDEV + 'api/v1/hotelgeolocation', httpOptions);
  }

  getSlider() {
    return this.http.get(APIDEV + 'api/internal/getSlider');
  }
  ...
  AirLowFareSearchPort(d: string, a: string, date: string, r_date: string, adult: string, child: string, infant: string, cabin: string, type: string) {
    ...
    return this.http.get(APIDEV + 'api/v1/flight/search', httpOptions);
  }
  ...
  searchHotel(geo: string, start_date: string, end_date: string) {
    ...
    return this.http.get(APIDEV + 'api/v1/hotel/search', httpOptions);
  }
  ...
  getDetailHotel(id: string, startDate: string, endDate: string) {
    ...
    return this.http.post(APIDEV + 'api/v1/hotel/detail', userData, {headers: urlHeader});
  }
  ...
  checkInventoryHotel(supplier, id: string, total_price: number, currency: string, roomTypeData: any) {
    ...
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    return this.http.post(APIDEV + 'api/v1/hotel/checkinventory', userData, {headers: urlHeader});
  }

  AirBookingInsertDB(sessionID: string, data: any) {
    var userData = 'sessionID=' + sessionID + '&data=' + data;
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    return this.http.post(APIDEV + 'api/internal/flight/insertSelectedBooking', userData, {headers: urlHeader});
  }
  ...
  HotelBookingInsertDB(sessionID: string, data: any, room_data: any, room_price, master_data: string, start_date: string, duration: string) {
    ...
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    return this.http.post(APIDEV + 'api/internal/hotel/insertSelectedBooking', userData, {headers: urlHeader});
  }

  AirBookingGetDataDB(sessionID: string) {
    var userData = 'sessionID=' + sessionID;
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    return this.http.post(APIDEV + 'api/internal/flight/getSelectedBooking', userData, {headers: urlHeader});
  }

  HotelBookingGetDataDB(sessionID: string) {
    var userData = 'sessionID=' + sessionID;
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    return this.http.post(APIDEV + 'api/internal/hotel/getSelectedBooking', userData, {headers: urlHeader});
  }

  AirPricePort(sessionID: any) {
    var userData = 'sessionID=' + sessionID;
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    return this.http.post(APIDEV + 'api/v1/flight/prebooking', userData, {headers: urlHeader});
  }
  ...
  AirCreateReservationPort(sessionID, title, firstname, lastname, dob, email, phone, passengerData, supplier) {
    ...
    return this.http.post(APIDEV + 'api/v1/booking/insertBookingData', userData, {headers: urlHeader});
  }

  paymentChannelEspay(sessionID) {
    var urlHeader = new HttpHeaders({'Content-Type': 'application/x-www-form-urlencoded'});
    var userData = 'sessionID=' + sessionID;
    return this.http.post(APIDEV + 'api/v1/payment/paymentChannelEspay', userData, {headers: urlHeader});
  }
  ...
  insertPaymentChannelEspay(bookingID, bankCode, origin, destination, departureTime, airPlane, roundType) {
    ...
    return this.http.post(APIDEV + 'api/v1/payment/orderPaymentEspay', userData, {headers: urlHeader});
  }
  ...
  retrieveBooking(emailAddress, bookingID) {
    ...
    return this.http.post(APIDEV + 'api/v1/flight/retrieveBooking', userData, {headers: urlHeader});
  }
